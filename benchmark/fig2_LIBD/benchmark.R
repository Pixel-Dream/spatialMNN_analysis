...
if(run_SLAT | run_MENDER){
    source("/users/hzhou1/benchmark/benchmarking_Rwrapper_func.R")
    samplePaths <- c("/users/hzhou1/benchmark/datasets/sample_151507.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151508.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151509.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151510.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151669.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151670.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151671.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151672.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151673.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151674.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151675.h5ad",
                    "/users/hzhou1/benchmark/datasets/sample_151676.h5ad")

    sampleNames <- c("sample_151507", "sample_151508", "sample_151509", "sample_151510",
                    "sample_151669", "sample_151670", "sample_151671", "sample_151672",
...
if(run_BANKSY){
  message(paste(Sys.time(),": start running BANKSY"))
    ...
    bench_res <- rkd_res(bench_res,tic,toc,mem_usage,"BANKSY",
                         label_vec  = spe$layer_guess_reordered_short, 
                         result_vec = df$result,
                         sample_vec = spe$sample_id)

    for(i in unique(df$sample)){
        idx = df$sample == i
        fig_ls[[paste0("BA_",i)]] <- draw_slide_bench(df$x[idx], df$y[idx],
...
# Save result
saveRDS(fig_ls, file.path(save_path,paste(Sys.Date(),batch_no,"LIBD_bench_fig.rds", sep = "_")))
write_tsv(bench_res[bench_res$ari_vec != "-",],
          file.path(save_path,paste(Sys.Date(),batch_no,"LIBD_bench_res.tsv", sep = "_")))
